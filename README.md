...
To be honest, similar techniques are executed by SQLmap. This is simply an alternative tool targeted towards boolean-based blind injection focusing on more manual testing (for determining parameters) and less guesswork.
